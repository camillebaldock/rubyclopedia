...
Then /^I should see a popup with the text "(.*?)"$/ do |popupText|
  page.driver.browser.switch_to.alert.text.should == popupText
end
...
Then /^"([^\"]*)" should( not)? be disabled$/ do |label, negate|
  ...
  ["false", "", nil].send(negate ? :should : :should_not, include(:disabled))
end